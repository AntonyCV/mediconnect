...
function Citas() {
  ...
  // Trae las citas del backend usando token
  useEffect(() => {
  ...
  return (
    <div className="cita-container">
      {/* --- Estilos embebidos (puedes moverlos a un css si quieres) --- */}
      <style>
        {`
        .sidebar {
          position: fixed;
      ...
      <div className="sidebar">
        <div className="sidebar-menu">
          ...
          <Link to="/cita" className="sidebar-link active" title="Ver mis citas">
